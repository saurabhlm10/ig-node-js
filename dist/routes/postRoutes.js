...
router.get("/publishPost/:t", publishPost_1.publishPost);
router.get("/uploadMediaContainer/:t", uploadMediaContainer_1.uploadMediaContainer);
router.get("/uploadToCloud/:t", video_validator_1.videoValidator, uploadToCloud_1.uploadToCloud);
